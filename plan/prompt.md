...
| R07 | NOT_STARTED | — | No full real-model demo certified; requires R02 real inference on approved hardware + demo case/language from user |
| B01 | NOT_STARTED | — | After demo priority unless explicitly assigned; translation/source/content authorization |
...
| B05 | NOT_STARTED | — | Backend Gate B checkpoint; requires B01–B04 |
