"""
Sthira Hazard, Exposure & Geospatial Module (ARC-C03 / C1-03).
...
from sthira.core.contracts import GeoPoint, GeoPolygon
from sthira.core.errors import OutOfCoverageError
