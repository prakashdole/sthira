"""
Sthira Source Catalog, Ingestion & AOI Gate Module (ARC-C02, ARC-C13 / C1-02).
...
from sthira.core.contracts import SourceMetadata, utc_now
from sthira.core.enums import SourceActivationState, SourceCapability
from sthira.core.errors import MissingEvidenceError
