"""
Sthira Land Truth & Discrepancy Detection Module (ARC-C04 / C1-04).
...
from sthira.core.contracts import GeoPoint, utc_now
from sthira.core.enums import DiscrepancyType
