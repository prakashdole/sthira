"""
Sthira Multi-State Adaptation & Legal Isolation Framework (PH-5 / C5-01).
...
from sthira.core.contracts import UserContext, utc_now
...
class StatePackageLoader:
    ...
    def _seed_reference_state_packages(self):
        ...
        uk_pkg = StatePackage(
            ...
            schemes=[
                ResettlementSchemeNorm(
                    scheme_id="SCHEME-UK-Sthira-2021",
                    name="Uttarakhand Mukhya Mantri Sthira Yojana (Hill Resettlement Policy)",
