"""
Sthira Source Access, Provider Health & Blocker Gating Service (ARC-C13).
...
class SourceAccessService:
    ...
    def _init_basemap_configs(self):
        ...
        self._basemap_configs["S53"] = BasemapConfigRecord(
            provider_id="S53",
            style_version="MapLibre-Sthira-v2.1",
            attribution="© OpenStreetMap contributors, ODbL 1.0; Sthira Cartographic Shell",
