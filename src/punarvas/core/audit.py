"""
PUNARVAS-AI Tamper-Evident Append-Only Audit Logger (ARC-C11).
...
from punarvas.core.contracts import AuditEntry
from punarvas.core.errors import AuditIntegrityError
