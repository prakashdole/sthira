"""
PUNARVAS-AI Delivery Execution, Funding Gap Calculator, Defect Clearance & External Handoff Engine (Phase 10 / ARC-C12 / FEAT-023, FEAT-025).
...
from punarvas.core.enums import AuthorityState, FundingState, RelocationPathway, RoleType
